...
do
{
	...
	{
		if(a==3&&manupoint==1)
		cout<<'|'<<setw(27)<<">>Start game<<"<<setw (15)<<'|'<<endl;
		else if(a==3)
		cout<<'|'<<setw(25)<<"Start game"<<setw (17)<<'|'<<endl;
		else if(a==5&&manupoint==2)
		cout<<'|'<<setw(27)<<">> Leader board <<"<<setw (15)<<'|'<<endl;
		else if(a==5)
		cout<<'|'<<setw(24)<<"Leader board"<<setw (18)<<'|'<<endl;
		else if(a==7&&manupoint==3)
		cout<<'|'<<setw(27)<<">>Select difficulty<<"<<setw (15)<<'|'<<endl;
		else if(a==7)
		cout<<'|'<<setw(25)<<"Select difficulty"<<setw (17)<<'|'<<endl;
		else if(a==9&&manupoint==4)
		cout<<'|'<<setw(27)<<">>Leave<<"<<setw (15)<<'|'<<endl;
		else if(a==9)
		cout<<'|'<<setw(25)<<"Leave"<<setw (17)<<'|'<<endl;
		if(a==11)
